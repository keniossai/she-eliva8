...
(function(factory) {
    ...
    var defaults = {
        ...
        onClick: null,
        icon_type: 'class',
        template: '<div data-notify="container" class="col-11 col-sm-4 alert alert-{0}" role="alert"><button' +
            ' type="button" aria-hidden="true" class="close" data-notify="dismiss">&times;</button><span' +
